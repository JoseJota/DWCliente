window.onload = function () {
  ...
  function creartabla(largo, ancho) {
    ...
    document.getElementById().addEventListener("click", celdaClic, false);
  
/*         document.getElementById(celda.id).disabled=true;

        document.getElementById(celda.id).addEventListener('click', celdaClic, false); */
      }
